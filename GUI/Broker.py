...
class BrokerDialog(QDialog):
    def __init__(self, *args, **kwargs):
        ...
        self.sslInsecure = QCheckBox("SSL insecure")
        self.sslInsecure.setChecked(self.settings.value("sslInsecure", False, bool))
        ...
        hfl.addRow("SSL insecure", self.sslInsecure)
    ...
    def accept(self):
        ...
        self.settings.setValue("sslInsecure", self.sslInsecure.isChecked())
        self.settings.sync()
